	...
	<div class = "container well" style = ";margin-top:90px" >
		<div class = "row wellko span6" style = "margin-left:240px">
			...
			<?php foreach ($row as $query) :?>
				...
				<a href="update_user.php?id=<?=$query['id']?>"><button>UPDATE</button></a>
				<a href="delete_user.php?id=<?=$query['id']?>"><button onclick = "return confirm('are you sure you want to delete this Question ?')">DELETE</button></a>
			<?php endforeach; ?>
